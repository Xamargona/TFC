                        ...
                        @if (Auth::user()->role == 'artist')
                            ...
                            <li>
                                <a href="{{ route('bookings.index') }}"
                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Reservas</a>
                            </li>
                        @endif
                        @if (Auth::user()->role == 'admin')
                            ...
                            <li>
                                <a href="{{ route('contactMessages.index') }}"
                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Ver incidencias</a>
                            </li>
                        @endif
                        <li>
                            <a href="{{ route('chats.index') }}"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Ver chats</a>
                        </li>
                        <li>
                            <a href="{{ route('logout') }}"
